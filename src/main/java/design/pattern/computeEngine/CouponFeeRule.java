 ...
 * @Date 2019-08-29
 **/
public class CouponFeeRule extends BaseFeeRule{

    private BaseFeeRule baseFeeRule;

    private Integer coupon;

    public CouponFeeRule(Integer coupon, BaseFeeRule baseFeeRule){
        this.coupon = coupon;
    ...
    public Integer computeReal(InsuredInfo insuredInfo) {
        return baseFeeRule.computeReal(insuredInfo) - coupon;
    }
}
